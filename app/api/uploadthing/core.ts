...
export const ourFileRouter = {
  ...
  media: f({ image: { maxFileSize: "4MB", maxFileCount: 1 } }) // media must be the same as argumennt in AcountProfile.tsx for this line of code -> useUploadThing("media")
...
export type OurFileRouter = typeof ourFileRouter; // koristi se i u core.ts ali takodje i u lib/uploadthing.ts
